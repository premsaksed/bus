...
<div class="container-fluid">
	<form id="find_schedule">
		<div class="col-md-12">
			...
			<div class="form-group mb-2">
				<label for="from_location" class="control-label">การออกเดินทาง</label>
			...
			?>
			<div class="form-group mb-2">
				<label for="to_location" class="control-label">จุดหมาย</label>
			...
			<div class="form-group mb-2">
				<label for="departure_time" class="control-label">วันที่</label>
