	...
	<form id="manage_schedule">
		<div class="col-md-12">
			<div class="form-group mb-2">
				<label for="bus_id" class="control-label">ชื่อรถบัส</label>
				...
				<select name="bus_id" id="bus_id" class="form-control" required>
					<option value="" <?php echo isset($meta['bus_id']) && $meta['bus_id'] > 0 ? '' : 'selected'  ?> disabled="">เลือก</option>
			...
			<div class="form-group mb-2">
				<label for="from_location" class="control-label">จาก</label>
				<select name="from_location" id="from_location" class="form-control" required>
					<option value="" <?php echo isset($meta['to_location']) && $meta['from_location'] > 0 ? '' : 'selected'  ?> disabled="">เลือก</option>
			...
			?>
			<div class="form-group mb-2">
				<label for="to_location" class="control-label">ถึง</label>
				<select name="to_location" id="to_location" class="form-control" required>
					<option value="" <?php echo isset($meta['to_location']) && $meta['to_location'] > 0 ? '' : 'selected'  ?>  disabled="">เลือก</option>
			...
			<div class="form-group mb-2">
				<label for="departure_time" class="control-label">เวลาออกเดินทาง</label>
			...
			<div class="form-group mb-2">
				<label for="eta" class="control-label">ถึงเวลา</label>
			...
			<div class="form-group mb-2">
				<label for="availability" class="control-label">จำนวนสูงสุด</label>
