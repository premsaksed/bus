  ...
  <footer id="footer">
    ...
    <div class="container-fluid d-md-flex py-4">
      ...
      <div class="mr-md-auto text-center text-md-left">
        <div class="copyright">
          &copy; Copyright <strong><span><a href="https://www.facebook.com/tragrapes.pisayakon/" target="_blank">Wutthimes Sirichaleeporn</a></span></strong>. All Rights Reserved
        </div>
      </div>
    </div>
  </footer>
    ...
    $.ajax({
      ...
      success:function(resp){
        ...
        if('<?php echo !isset($_SESSION['login_id']) ?>' == 1){
                if($book == 1){
                   $('#uni_modal .submit').html('จอง')
                }else{
                   $('#uni_modal .submit').html('ค้นหา')
