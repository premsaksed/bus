...
<main id="main">
	<div class="container-fluid">
		<div class="col-lg-12">
			...
			<div class="row">
				<div class="col-md-12">
					<button class="float-right btn btn-primary btn-sm" type="button" id="new_schedule">เพิ่ม <i class="fa fa-plus"></i></button>
				</div>
			</div>
		<?php endif; ?>
			<div class="row">
		...
		$.ajax({
			...
			complete:function(){
				...
				$('.book_now').click(function(){
					uni_modal('รายละเอียด','customer_book.php?id='+$(this).attr('data-id'),1)
				})
			}
		})
	}
